...
//
//	mockgen -typed -package quic -self_package github.com/nukilabs/quic-go -self_package github.com/nukilabs/quic-go -destination mock_packetconn_test.go net PacketConn
//
